...
@interface TowerViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    //数据源
...
{
    //解析数据
    _andriodData =  [NetWorkManager initXmlWithUrl:TowerProtectUrl success:nil faile:nil];
    //如果无数据 报告
    if (_andriodData == nil){
