...
@interface PS4ViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation PS4ViewController
...
{
    //解析数据
    _XboxOneData =  [NetWorkManager initXmlWithUrl:PS4Url success:nil faile:nil];
    //如果无数据 报告
    if (_XboxOneData == nil){
